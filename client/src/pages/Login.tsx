  ...
  return (
    ...
    <main className="login-page-container">
      <form onSubmit={handleSubmit} className="login-form">
        ...
        <p className="mt-2 text-sm text-gray-500/90 dark:text-gray-400">{state === 'login' ? 'Please enter email and password to access.' : 'Please enter yor details to create an account.'}
        </p>
          ...
          <div className="mt-4">
            <label className="font-medium text-sm text-gray-700 dark:text-gray-300">Username</label>
              <div className="relative mt-2">
                ...
                value={username} type="text" placeholder="Enter a username"
          ...
          <div className="mt-4">
            ...
            dark:text-gray-300">Password</label>
              <div className="relative mt-2">
                ...
                value={password} placeholder="Please enter your email"
