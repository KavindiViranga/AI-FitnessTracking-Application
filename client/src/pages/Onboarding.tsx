import { ArrowLeft, ArrowRight, PersonStanding, ScaleIcon, TargetIcon, User } from "lucide-react"
  ...
  const handleNext = async () => {
    if(step === 1) {
      if(!formData.age || Number(formData.age) < 13 || Number(formData.age) > 120) {
        return toast("Age is required and must be between 13 and 120")
      }
    }
    if(step < totalSteps) {
      setStep(step + 1)
    ...
    <div className="onboarding-container">
      <div className="p-6 pt-12 onboarding-wrapper">
        <div className="flex items-center gap-3 mb-2">
          ...
          dark:text-white">FitPulse</h1>
        </div>
        <p className="text-sate-500 dark:text-slate-400
        mt-4">Let's personalize your experience</p>
      </div>
      ...
      <div className="flex-1 px-6 onboarding-wrapper">
        {step === 1 && (
          <div className="space-y-6">
            ...
            <div>
              ...
              text-sm">This helps us customize your fitness plan</p>
            </div>
          </div>
        ...
        {step === 2 && (
          <div className="space-y-6 onboarding-wrapper">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400 
              text-sm">Help us track your progress and set goals</p>
            </div>
          </div>
        ...
        {step === 3 && (
          <div className="space-y-6 onboarding-wrapper">
            ...
            <div>
              <h2 className="text-lg font-semibold 
              text-slate-800 dark:text-white">What's your fitness goal?
              </h2>
              <p className="text-slate-500 dark:text-slate-400 
              text-sm">We'll help you set realistic goals</p>
            </div>
          </div>
          ...
          <div className="space-y-4 max-w-lg">
            {goalOptions.map((option)=>(
              ...
              onClick={()=>{
                ...
                setFormData({
                  ...formData, goal: option.value as 'lose' | 'maintain' | 'gain',
