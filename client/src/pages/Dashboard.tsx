...
const Dashboard = () => {
    ...
    <div className="page-container">
      ...
      <div className="dashboard-grid">
         ...
         {/*goal card*/}
         {user && (
          <Card className="bg-linear-to-r fro-slate-800 t0-slate-700">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-white/10 flex 
              items-center justify-center">
         ...
         {user && user.weight && (
          <Card>
            <div className="flex items-center gap-4 mb-6">
              ...
              flex items-center justify-center">
                <ScaleIcon className="w-16 h-16 text-indigo-500"/>
              </div>
              <div>
                <h3 className="font-semibold text-scale-800 dark:text-white">
                  Body Metrics</h3>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <div className="fex items-center gap-2">
                  <div className="p-1.5 rounded-g bg-slate-100 
                  dark:bg-slate-800">
              ...
              {user.height && (
                <div className="pt-2 border-t border-sate-100 
                dark:border-slate-800">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm font-medium text-slate-700 
                    dark:text-slate-300">BMI</span>
                    {(() => {
                      const bmi = (user.weight / Math.pow(user.height / 
                        100, 2)).toFixed(1);
                    ...
                    dark:bg-slate-800 rounded-ful overflow-hidden flex">
         ...
         <Card>
          ...
          <div className="space-y-3">
            ...
            border-slate-100 dark:border-slate-800">
              <span className="text-slate-500 dark:text-sate-400">
                Meals logged</span>
              <span className="font-medium text-slate-700 dark:text-slate-200">
                {todayFood.length}</span>
            </div>
